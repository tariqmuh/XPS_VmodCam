...
#
#  File     MCB_DDR2_list.do (Mon Feb 17 14:50:54 2014)
#
...
# eval add list $hexopt $tbpath${ps}MCB_DDR2${ps}s0_axi_awid
...
# eval add list $binopt $tbpath${ps}MCB_DDR2${ps}s0_axi_wvalid
  ...
  eval add list $hexopt $tbpath${ps}MCB_DDR2${ps}s0_axi_bid
...
# eval add list $hexopt $tbpath${ps}MCB_DDR2${ps}s0_axi_arid
...
# eval add list $binopt $tbpath${ps}MCB_DDR2${ps}s0_axi_arvalid
  ...
  eval add list $hexopt $tbpath${ps}MCB_DDR2${ps}s0_axi_rid
